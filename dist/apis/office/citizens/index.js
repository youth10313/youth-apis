...
var Share = function (id, body, token) {
    if (token === void 0) { token = ''; }
    return (0, request_1.YouthRoute)('post', "".concat(api_1.OFFICIAL_API, "citizens/share/").concat(id), {}, { token: token }, body);
};
...
var Citizens = { CreateLink: CreateLink, DeleteLink: DeleteLink, Join: Join, Left: Left, ApproveCitizen: ApproveCitizen, KickCitizen: KickCitizen, GetUserDepartments: GetUserDepartments, GetDepartmentCitizens: GetDepartmentCitizens, JoinByAdmin: JoinByAdmin, Share: Share };
