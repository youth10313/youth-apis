...
var Send = function (departments, message, token) {
    if (token === void 0) { token = ''; }
    return (0, request_1.YouthRoute)('post', "".concat(api_1.OFFICIAL_API, "blazer"), {}, { token: token }, { departments: departments, message: message });
};
