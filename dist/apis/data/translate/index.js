...
var AddLocale = function (app, locale) { return (0, request_1.YouthRoute)('post', "".concat(api_1.DATA_API, "localizations/").concat(app, "/").concat(locale), {}, {}, {}); };
var RemoveLocale = function (app, locale) { return (0, request_1.YouthRoute)('delete', "".concat(api_1.DATA_API, "localizations/").concat(app, "/").concat(locale), {}, {}, {}); };
var Translations = {
    Translate: Translate,
    App: App,
    Locale: Locale,
