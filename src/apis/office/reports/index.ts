...
const UpdateProject = (id: string, body: { title: string, dates: Date[], repeatType: "daily" | "weekly" | "monthly", members: string[], questions: [] }, token = '') => YouthRoute<{ msg: string }>('post', `${OFFICIAL_API}reports/${id}`, {}, { token }, body);
...
const Reports = { CreateProject, UpdateProject, RemoveProject, GetProjects, GetUserProjects, SendUserReport, GetProjectReports, GetUserProjectReports };
