...
const FetchAttachment = (id: string, file: string, Authorization = '', token: string = '') => YouthRoute<{ id: string }>('get', `${OFFICIAL_API}ads/${id}/attachments/${file}`, {}, { Authorization, token }, {});
